...
{
    public sealed partial class NuevaCategoria : Page
    {
        ...
        private async void BtnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            string sql = @"
            INSERT INTO categoria (nombre, parent_id, image_path)
            ...
            bool exito = await ImageResolver.GuardarImagenCategoria(ConstruirPathExplorerItem(itemSeleccionado),_image, TxtNombre.Text);
            //Mostrar un popup
    ...
    public class ExplorerItem
    {
        ...
        public bool EsCategoriaRaiz { get; set; }
    }
